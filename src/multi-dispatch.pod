...
covered in the chapter A<sec:grammars>.
...
Chapter A<sec:subs> showed how to use nested signatures to look deeper into data
...
as C<only sub YourSub>.  At the time of writing, only Rakudo supports this..
