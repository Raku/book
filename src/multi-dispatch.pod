...
N<One of the very rare exceptions is the smart match operator
C<< infix:<~~> >> which is not overloadable easily, but which redispatches
to overloadable multi methods.>>
