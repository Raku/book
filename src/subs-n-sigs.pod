...
all remaining positional arguments and stores them in the array.

Likewise C<*%hash> slurps all the remaining named arguments into a hash.
...
The ASCII art examples from earlier would have been prettier if they had used
...
a way to deal with captures directly, and occasionally it's useful
to do so.
