...
Is "interpolate" better than "flatten"?
...
I<interpolate> them into the argument list by prepending a vertical bar:
C<eat(|@food)>.
...
parameter in the subroutine. The I<slurpy> sigil (C<*>) before the parameter
