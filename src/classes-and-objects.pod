...
this tells the method dispatcher to consider all of the methods on the base 
class, including attribute accessors, when determining the method to dispatch 
to on the inherited class.
...
significant improvement over Perl 5.  
