...
method on the resulting string, passing a string consisting of a single blank to it.
...
each item of the list, setting the variable C<$line> to the current value.
