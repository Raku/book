...
Sometimes coercion is intuitively transparent.  Perl 6 has sevearl numeric
...
default. You may specify the unit with an argument of C<Degree>, C<Gradians> or
...
Constructs such as C<if> automatically evaluate their conditions in boolean
context. You can force numeric context by putting a C<?> in front of an
expression.  The C<!> prefix negates the boolean value.
